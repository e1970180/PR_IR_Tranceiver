#include <TionBreatherIR.h>

TionBreatherIR::TionBreatherIR()
{
  static const char PROGMEM model[] PROGMEM = "tion";
  static const char PROGMEM info[]  PROGMEM = "{\"mdl\":\"Tion\",\"dn\":\"Tion\",\"mT\":16,\"xT\":30,\"fs\":3}";
...
void TionBreatherIR::send(IRSender& IR, uint8_t powerModeCmd, uint8_t operatingModeCmd, uint8_t fanSpeedCmd, uint8_t temperatureCmd)
{
...
void TionBreatherIR::sendBallu(IRSender& IR, uint8_t powerMode, uint8_t operatingMode, uint8_t fanSpeed, uint8_t temperature)
{
